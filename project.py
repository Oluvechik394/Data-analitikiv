...
# Гістограма заробітної плати з покращеннями
...
# Додавання тексту для кожної точки
...
# Додавання нової точки з підписом 'R'
plt.scatter(4.2, 70000, color='blue')
plt.text(4.2, 70000, 'R', fontsize=9, ha='right')

# Зміна координат існуючої точки та оновлення підпису на 'Spark'
